...
class Item_UI(Zone_UI):
    ...
    def __init__(self,box,lab_text,texture,spr_vis=False,colorlab=c['F']):
...
class Invent_UI(Item_UI):
    ...
    def __init__(self,box,item,spr_vis=False):
        ...
        super(Invent_UI,self).__init__(box,lab_text,g.TEXTIDS[cquecé.lower()][convert_quality(item.quality)[0]],spr_vis=spr_vis,colorlab=col)
