...
class Zone_UI(Zone):
    ...
    def __init__(self,box2,lab_text='UIthg',textid='white',group='ui',makeCol=False,longpress=False):
...
class Plume_UI(Zone_UI):
    ...
    def __init__(self,box,plume):
        ...
        super(Plume_UI,self).__init__(box,lab_text,group='ui',makeCol=False)
...
class Writingphase_UI(Item_UI):
    ...
    def __init__(self,box,phase):
        ...
        super(Writingphase_UI,self).__init__(box,lab_text,g.TEXTIDS['phase'][convert_quality(phase.quality)[0]])

        self.phase = phase

class Invent_UI(Item_UI):

    def __init__(self,box,item,spr_vis=False):
        #print(spr_vis)
